...
var I18N_MESSAGES = {
  en: {
    ...
    pricing_gift_desc: 'Send a capsule to a recipient with a scheduled reveal date.',
  ...
  tr: {
    ...
    pricing_limited_badge: 'Şimdi Kullanılabilir',
    ...
    pricing_gift_desc: 'Bir alıcıya planlanmış açılış tarihiyle kapsül gönderin.',
