...
var I18N_MESSAGES = {
  en: {
    ...
    hero_subtitle: 'Save a place that matters to you, write the story behind it, and choose whether it stays visible now or opens later as a capsule.',
    ...
    how_step3_body: 'Keep it visible now as a public mark, or turn it into a capsule that opens on a future date.',
    ...
    pricing_capsule_desc: 'Save your mark now and choose a future opening date so the memory opens later with more meaning.',
    ...
    pricing_gift_desc: 'Send a capsule to someone special with a recipient email and a scheduled opening date.',
    ...
    pricing_note: 'Every memory starts with a place and a written note. Add a photo if you want, then decide whether it stays public on the globe or waits to open later as a capsule.',
    ...
    start_hint: 'Open the panel, choose whether you want to leave a mark or create a capsule, then save a place that matters to you.',
    ...
    capsule_flow_sub: 'Opens on the date you choose and keeps the moment personal',
    ...
    onboarding_sub: 'Choose whether you want to leave a visible mark now or plan a capsule that opens later.',
    ...
    onboarding_step2_body: 'Write a message now and let it open on a future date for yourself or someone else.',
  ...
  tr: {
    ...
    hero_subtitle: 'Senin için anlam taşıyan bir yeri kaydet, arkasındaki hikâyeyi yaz ve bunun şimdi mi görüneceğine yoksa daha sonra bir kapsül olarak mı açılacağına karar ver.',
    ...
    how_step3_body: 'Bunu şimdi herkese açık bir iz olarak bırak ya da gelecekte açılacak bir kapsül olarak sakla.',
    ...
    pricing_capsule_desc: 'İzini şimdi kaydet ve anının daha sonra, daha anlamlı bir anda açılması için bir tarih seç.',
    ...
    pricing_gift_desc: 'Bir alıcı e-postası ve açılış zamanı ile özel bir kapsülü sevdiğin birine gönderebilirsin.',
    ...
    pricing_note: 'Her anı bir yer ve yazılı bir not ile başlar. İstersen fotoğraf ekle; sonra bunun küre üzerinde herkese açık mı kalacağına yoksa daha sonra açılacak bir kapsül mü olacağına karar ver.',
    ...
    start_hint: 'Paneli aç, ister bir iz bırak ister bir kapsül oluştur; sonra senin için anlam taşıyan bir yeri kaydet.',
    ...
    capsule_flow_sub: 'Seçtiğin tarihte açılır ve anı kişisel tutar',
    ...
    onboarding_sub: 'Şimdi görünen bir iz mi bırakmak istiyorsun, yoksa ileride açılacak bir kapsül mü planlamak istiyorsun? Seç.',
    ...
    onboarding_step2_body: 'Mesajını şimdi yaz, gelecekte açılacağı tarihi seç ve istersen bunu kendine ya da bir başkasına bırak.',
