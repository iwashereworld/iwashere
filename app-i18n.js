...
var I18N_MESSAGES = {
  en: {
    ...
    hero_eyebrow: 'A world map for meaningful memories',
    hero_title_html: 'Leave your <em>mark</em><br>on the world',
    hero_subtitle: 'Place a mark on the globe, write a memory, and choose whether it stays visible now or opens later.',
    ...
    how_step1_body: 'Pick the exact place on the globe where you want your memory to live.',
    how_step2_title: 'Write Your Message',
    how_step2_body: 'Write the message you want to save with your mark. A photo is optional.',
    how_step3_title: 'Choose Visibility',
    how_step3_body: 'Keep it visible now, or set a future opening date and turn it into a capsule.',
    pricing_label: 'What You Can Save',
    pricing_title_html: 'Simple options for what you can <em>save today</em>',
    ...
    pricing_note: 'Each mark starts with a place and a written memory. Add a photo if you want, then choose whether it stays public or opens later as a capsule.',
    ...
    capsule_options_sub: 'Choose whether this should stay public now or open later as a capsule.',
    recipient: 'Recipient',
    myself: 'Myself',
    ...
    or: 'or',
    no_capsule: 'No Capsule (save as public mark)',
