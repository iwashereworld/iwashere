...
var I18N_MESSAGES = {
  ...
  tr: {
    ...
    add_mark: 'Iz Birak',
    create_capsule: 'Kapsul Olustur',
    close_composer: 'Kapat',
    close_composer_sub: 'Bu akistan cik ve kureye geri don',
    add_mark_sub: 'Aninda haritada gorunur',
    create_capsule_sub: 'Ileride secilen tarihte acilir',
    mark_flow_title: 'Su anini birak',
    mark_flow_sub: 'Aninda haritada gorunur',
    capsule_flow_title: 'Gelecege mesaj planla',
    capsule_flow_sub: 'Sectigin tarihte acilir',
    step_mark_review: 'Ozeti kontrol et ve izini birak.',
    step_capsule_review: 'Kapsulu planlamadan once ozeti kontrol et.',
    selected_place_label: 'Secili Yer',
    no_locked_place: 'Henuz bir konum kilitlenmedi.',
    save_capsule: 'Kapsul Olustur',
    mark_success_visible: 'Izin artik kure uzerinde gorunur.',
    capsule_success_visible: 'Kapsulun kaydedildi ve sectigin tarihte acilacak.',
    later: 'Sonra',
    next_up: 'Siradaki',
    ...
    auth_email: 'E-posta',
    auth_password: 'Sifre',
    onboarding_welcome: 'Iceridesin',
    onboarding_title: 'Dunyanı iki kolay yoldan baslat',
    onboarding_sub: 'Simdi gorunen bir iz mi birakmak istiyorsun, yoksa ilerisi icin bir kapsul mu planlamak istiyorsun sec.',
    onboarding_step1_title: 'Iz Birak',
    onboarding_step1_body: 'Bir yer sec, mesajini yaz ve hemen kurede gorunur hale getir.',
    onboarding_step2_title: 'Kapsul Olustur',
    onboarding_step2_body: 'Mesajini simdi yaz, gelecekte acilacagi tarihi sec.',
    onboarding_step3_title: 'Her zaman geri donebilirsin',
    onboarding_step3_body: 'Giris yaptiktan sonra izlerin, kapsullerin ve profilin seni bekler.',
    onboarding_cta_mark: 'Iz Birakarak Basla',
    onboarding_cta_capsule: 'Kapsul Ile Basla',
    onboarding_cta_later: 'Sonra bakarim',
    ...
    recipient_hint_self: 'Acilinca hatirlatma e-postasi sana geri gelir.',
    recipient_hint_other: 'Acilinca aliciya e-posta gider ve sana teslim onayi gelir.',
    recipient_hint_disabled: 'Bu yapida aliciya teslim ozelligi henuz acik degil.',
