...
var I18N_MESSAGES = {
  en: {
    ...
    pricing_note: 'Voice recording is currently local preview only. Delivery, notification, and reveal flows may continue to evolve as the product backend expands.',
  ...
  tr: {
    ...
    how_step2_body: 'İzinle birlikte kaydedilecek metni ekle. Fotoğraf isteğe bağlıdır; ses şu anda yalnızca cihaz içinde önizlenir.',
    ...
    pricing_note: 'Ses kaydı şu anda yalnızca yerel önizleme olarak çalışır. Teslimat, bildirim ve reveal akışları backend genişledikçe gelişmeye devam edebilir.',
    ...
    your_message_sub: 'İzinle birlikte kaydedilecek mesajı yaz. Ses şu an yalnızca önizleme olarak kalır.',
    write: 'Yaz',
    voice: 'Ses',
    message: 'Mesaj',
    message_placeholder: 'Bugün İstanbul’da buradaydım ve bu günü hatırlamak istiyorum...',
    voice_note: 'Ses kayıtları şu anda yalnızca bu cihazda yerel önizleme olarak tutulur. Bugün kaydetmek istiyorsan yazılı bir mesaj ekle.',
    voice_ready: 'Yerel kayıt için hazır',
    voice_tap_start: 'Başlatmak için dokun',
    voice_upload_pending: 'Backend yüklemesi bağlandığında yükleme metadatası burada görünecek.',
    clear_rerecord: 'Temizle ve yeniden kaydet',
