...
var I18N_MESSAGES = {
  en: {
    ...
    mark_flow_title: 'Leave this moment',
    mark_flow_sub: 'Visible on the map right away',
    capsule_flow_title: 'Plan a message for later',
    capsule_flow_sub: 'Opens on the date you choose',
    ...
    onboarding_title: 'Start your world in two simple ways',
    onboarding_sub: 'Choose whether you want to leave a visible mark now or plan a capsule for later.',
    ...
    onboarding_step2_body: 'Write a message now and let it open on a future date.',
  ...
  tr: {
    ...
    hero_eyebrow: 'Anlamlı anılar için dünya haritası',
    hero_title_html: 'Dünyaya <em>izini</em><br>bırak',
    hero_subtitle: 'Anlamlı bir yeri kaydet, ardındaki anıyı yaz ve bunun şimdi mi görüneceğine yoksa sonra mı açılacağına karar ver.',
    hero_how: 'Nasıl Çalışır',
    stat_marks: 'Bırakılan İz',
    stat_countries: 'Ülkeler',
    stat_capsules: 'Aktif Kapsüller',
    how_label: 'Nasıl Çalışır',
    how_title_html: 'Bir <em>anıyı</em> kaydetmek için üç adım',
    how_step1_title: 'Yerini Seç',
    how_step1_body: 'Bu anının ait olduğu noktayı küre üzerinde tam olarak seç.',
    how_step2_title: 'Mesajını Yaz',
    how_step2_body: 'Bu yere anlamını verecek mesajı yaz. İstersen fotoğraf da ekleyebilirsin.',
    how_step3_title: 'Şimdi Göster ya da Sonra Aç',
    how_step3_body: 'Bunu şimdi herkese açık bir iz olarak bırak ya da gelecekte açılacak bir kapsül olarak kilitle.',
    pricing_label: 'Neler Kaydedebilirsin',
    pricing_title_html: 'Bir yeri <em>kaydetmenin sade yolları</em>',
    ...
    pricing_capsule_desc: 'İzini şimdi kaydet ve anının daha sonra açılması için bir tarih seç.',
    ...
    pricing_gift_desc: 'Bir alıcı e-postası ve açılış zamanı ile kapsül gönderebilirsin.',
    ...
    pricing_note: 'Her anı bir yer ve yazılı bir not ile başlar. İstersen fotoğraf ekle, sonra bunun herkese açık mı kalacağına yoksa kapsül olarak mı açılacağına karar ver.',
    ...
    start_hint: 'Paneli aç, bir yer seç ve küre üzerindeki ilk anını kaydet.',
    ...
    mark_flow_title: 'Şu anını bırak',
    mark_flow_sub: 'Anında haritada görünür',
    capsule_flow_title: 'Geleceğe mesaj planla',
    capsule_flow_sub: 'Seçtiğin tarihte açılır',
    ...
    quick_start_1: 'İzinde görünecek ismi seç.',
    quick_start_2: 'Tam yeri görmek için küreye bir kez tıkla.',
    quick_start_3: 'Yeri onayla, mesajı tamamla ve kaydet.',
    ...
    onboarding_title: 'Dünyanı iki kolay yoldan başlat',
    onboarding_sub: 'Şimdi görünen bir iz mi bırakmak istiyorsun, yoksa ilerisi için bir kapsül mü planlamak istiyorsun? Seç.',
    ...
    onboarding_step2_body: 'Mesajını şimdi yaz, gelecekte açılacağı tarihi seç.',
