...
Assert-Contains $config 'CAPSULE_BACKEND_MODE' 'app-config.js must define CAPSULE_BACKEND_MODE fallback.'
Assert-Contains $config 'CAPSULE_EMAIL_ENABLED' 'app-config.js must define CAPSULE_EMAIL_ENABLED fallback.'
...
Assert-Contains $runtimeConfig 'process.env.CAPSULE_BACKEND_MODE' 'api/runtime-config.js must read CAPSULE_BACKEND_MODE from env.'
Assert-Contains $runtimeConfig 'process.env.CAPSULE_EMAIL_ENABLED' 'api/runtime-config.js must read CAPSULE_EMAIL_ENABLED from env.'
...
Assert-Contains $health 'capsuleBackendMode' 'api/health.js must expose capsule backend mode.'
Assert-Contains $health 'capsuleEmailEnabled' 'api/health.js must expose capsule email readiness.'
...
Assert-Contains $helpers 'function getCapsuleBackendMode()' 'app-helpers.js must define getCapsuleBackendMode().'
Assert-Contains $helpers 'function isCapsuleEmailEnabled()' 'app-helpers.js must define isCapsuleEmailEnabled().'
...
Assert-Contains $supabaseVercelEnvMap 'CAPSULE_BACKEND_MODE' 'supabase/vercel-env-map.md must document capsule backend mode.'
