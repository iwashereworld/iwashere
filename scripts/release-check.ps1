...
Assert-Contains (Get-Content -Raw (Join-Path $root 'app-i18n.js')) "hero_eyebrow: 'Anlamlı anılar ve geleceğe bırakılan mesajlar için yaşayan bir küre'" 'app-i18n.js must keep the cleaned Turkish copy in the base file.'
